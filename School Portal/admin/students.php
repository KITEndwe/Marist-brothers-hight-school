...
<title><?= ucfirst(str_replace('-', ' ', 'students')) ?> · MBN Portal</title>
...
<div class="app">
  ...
  <main class="main">
    <div class="topbar">
      <div>
        <h1><?= ucfirst(str_replace('-', ' ', 'students')) ?></h1>
    ...
    <div class="panel">
      <p style="color:var(--slate); font-size:14px;">
        The <b>admin/students.php</b> page is scaffolded and protected by the same login/session
