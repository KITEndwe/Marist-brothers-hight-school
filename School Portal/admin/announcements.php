...
<div class="app">
  ...
  <main class="main">
    <div class="topbar">
      <div>
        <h1>Announcements</h1>
        <div class="meta">Post school-wide notices for students, teachers, or everyone</div>
      </div>
    </div>
        ...
        <div class="panel">
          ...
          <ul class="timeline">
            ...
            <?php if (!$announcements): ?>
              <li style="color:var(--slate)">No announcements posted yet.</li>
            <?php endif; ?>
          </ul>
        </div>
      </div>
        ...
        <div class="panel">
          ...
          <form action="announcement_save.php" method="POST">
            ...
            <div class="field">
              ...
              <input type="text" id="category" name="category" placeholder="Exams, Events, Info..." required>
            </div>
            <div class="field">
