...
<title><?= ucfirst(str_replace('-', ' ', 'reports')) ?> · MBN Portal</title>
...
<div class="app">
  ...
  <main class="main">
    <div class="topbar">
      <div>
        <h1><?= ucfirst(str_replace('-', ' ', 'reports')) ?></h1>
    ...
    <div class="panel">
      <p style="color:var(--slate); font-size:14px;">
        The <b>admin/reports.php</b> page is scaffolded and protected by the same login/session
